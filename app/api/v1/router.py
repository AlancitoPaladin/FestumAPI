...
from app.api.v1.endpoints.provider_order_requests import router as provider_order_requests_router
...
api_router.include_router(provider_order_requests_router, prefix="/providers", tags=["providers"])
